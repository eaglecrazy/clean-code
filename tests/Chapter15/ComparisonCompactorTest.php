...
class ComparisonCompactorTest extends TestCase
{
    ...
    {
        $failure = (new ComparisonCompactor(0, "b", "c"))->compact("a");
        self::assertTrue("a expected:<[b]> but was:<[c]>" === $failure);
    }

    public function testStartSame()
    {
        $failure = (new ComparisonCompactor(1, "ba", "bc"))->compact('');
    ...
    {
        $failure = (new ComparisonCompactor(10, "S&P500", "0"))->compact('');
